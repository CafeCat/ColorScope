...
begin
  ...
  begin
      renameFile(Form1.paletteFolderPath+'\'+Form1.list_pp.Items.Strings[Form1.list_pp.ItemIndex]+'.dat',Form1.paletteFolderPath+'\'+pt_filename.Text+'.dat');
      ...
      form1.main_status.Panels[0].Text := 'File is renamed';
      form1.main_status.Panels[1].Text := pt_filename.Text;
      Form3.Close;
  end else
  begin
      MessageDlg('A palette named '+pt_filename.Text+' with is already existed.', mtWarning, [mbOK], 0);
